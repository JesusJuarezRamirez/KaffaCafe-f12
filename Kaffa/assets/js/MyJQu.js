   ...
   $('#bookonline').find('input').focusin(function(){
	  ...
	  $('.myimage').click(function(){
	   ...
	   $($('.staff').find('li')).click(function(){
		   ...
		   $('.facebook').mouseenter(function(){$(this).attr('src','../assets/images/fbhover.png')}).
		   mouseleave(function(){$(this).attr('src','../assets/images/fb.png')}); 
		   $('.google').mouseenter(function(){$(this).attr('src','../assets/images/g+hover.png')}).
		   mouseleave(function(){$(this).attr('src','../assets/images/g+.png')});
